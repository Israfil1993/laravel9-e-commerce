                    ...
                    <form action="{{ route('backend.product.store') }}" method="post" enctype="multipart/form-data">
                        ...
                        <div class="card-body">
                            ...
                            <div class="form-group">
                                ...
                                <input type="number" class="form-control @error('title') is-invalid @enderror" name="quantity">
                            </div>
                            <div class="form-group">
                                <label>Minquantity</label>
                                <input type="number" class="form-control @error('title') is-invalid @enderror" name="minquantity">
                            </div>
                            <div class="form-group">
                                <label>Tax</label>
                                <input type="number" class="form-control @error('title') is-invalid @enderror" name="tax">
                            </div>
                            <div class="form-group">

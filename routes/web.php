...
//************************** ADMIN IMAGE GALLERY ROUTES **********************************
    ...
    Route::prefix('/images')->group(function (){
        Route::get   ('/',           [ImageGalleryController::class, 'index']) ->name('backend.images.index');
        ...
        Route::post  ('/update/{pid}',    [ImageGalleryController::class, 'update'])->name('backend.images.update');
        Route::delete('/delete/{pid}',    [ImageGalleryController::class, 'delete'])->name('backend.images.delete');
